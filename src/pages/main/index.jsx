        ...
        <div className="flex flex-col items-center justify-start">
            ...
            <div className="bg-white min-h-[392px] sm:min-h-[250px] flex items-center justify-center w-full pt-[28px] pb-[72px] sm:pb-[39px]">
                <div className="max-w-[575px] uppercase text-center w-full flex flex-col items-center justify-center">
                    ...
                    <span className="text-[#000] text-[24px] leading-[28px] font-medium text-center mb-[35px] sm:txet-[14px] sm:leading-[20px]">Use <span className="text-[#F46F51] text-italic">rocketlauncher.gg</span> and get 50% off on your first launch with my promo code</span>
